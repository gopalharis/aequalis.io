...
var pJS = function (e, t) {
    ...
    t && Object.deepExtend(m, t), m.tmp.obj = {
        ...
        if (m.interactivity.events.onhover.enable && isInArray("bubble", m.interactivity.events.onhover.mode)) {
            var e = c.x - m.interactivity.mouse.pos_x, t = c.y - m.interactivity.mouse.pos_y,
            ...
            if (o <= m.interactivity.modes.bubble.distance) {
                if (0 <= a && "mousemove" == m.interactivity.status) {
                    if (m.interactivity.modes.bubble.size != m.particles.size.value) if (m.interactivity.modes.bubble.size > m.particles.size.value) {
                        ...
                        var s = c.radius - m.interactivity.modes.bubble.size, n = c.radius - s * a;
                        c.radius_bubble = 0 < n ? n : 0
                    }
                    var r;
                    if (m.interactivity.modes.bubble.opacity != m.particles.opacity.value) if (m.interactivity.modes.bubble.opacity > m.particles.opacity.value) (r = m.interactivity.modes.bubble.opacity * a) > c.opacity && r <= m.interactivity.modes.bubble.opacity && (c.opacity_bubble = r); else (r = c.opacity - (m.particles.opacity.value - m.interactivity.modes.bubble.opacity) * a) < c.opacity && r >= m.interactivity.modes.bubble.opacity && (c.opacity_bubble = r)
                }
            } else i();
            ...
            if (m.tmp.bubble_clicking) {
                ...
                var o = Math.sqrt(e * e + t * t), l = ((new Date).getTime() - m.interactivity.mouse.click_time) / 1e3;
            ...
            function v(e, t, a, i, s) {
                if (e != t) if (m.tmp.bubble_duration_end) null != a && (r = e + (e - (i - l * (i - e) / m.interactivity.modes.bubble.duration)), "size" == s && (c.radius_bubble = r), "opacity" == s && (c.opacity_bubble = r)); else if (o <= m.interactivity.modes.bubble.distance) {
